...
public class CensusAnalyser {
    ...
    /*Method To Return JSON File Of States According to State Population in Decreasing order*/
    ...
    /*Method To Return JSON File Of States According to State Area in Decreasing order*/
    public String areaWiseSortedCensusData() throws CensusAnalyserException {
